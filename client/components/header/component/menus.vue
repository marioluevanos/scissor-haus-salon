<template>
  <ul>
    ...
    >
      ...
      <div
        v-if="item.shop_mega_menus"
        class="shop-mega-menu tp-submenu tp-mega-menu"
      >
        <div class="row">
          <div
            v-for="(shop_m, i) in item.shop_mega_menus"
            :key="i"
            class="col-lg-2"
          >
            <div class="shop-mega-menu-list">
              <nuxt-link :href="shop_m.link" class="shop-mega-menu-title">{{
                shop_m.title
              }}</nuxt-link>
              <ul>
                <li v-for="(shop_sm, i) in shop_m.list_menus" :key="i">
                  <nuxt-link :href="shop_sm.link">{{
                    shop_sm.title
                  }}</nuxt-link>
                </li>
              </ul>
